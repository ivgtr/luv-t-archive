...
dotenv.config();
var _a = process.env, twitterId = _a.TWITTER_ID, twitterToken = _a.TWITTER_TOKEN;
var requestTwitterData = function () { return __awaiter(void 0, void 0, void 0, function () {
    var headers, options, count, url, timelineData;
                        ...
                        node_fetch_1["default"](url, options)
                            ...
                            result.map(function (tweet) {
                                if (tweet.extended_entities) {
                                    tweet.extended_entities.media.map(function (media) {
                                        var name = media.media_url.split('/');
                                        medias.push({
                                            url: media.url,
